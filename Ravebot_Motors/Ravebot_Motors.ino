...
void setup() {
  ...
  // led intensity
  pinMode(A8, INPUT_PULLUP);  //todo - change this - test if it's working for real when out of test mode!
...
servoInfo servos[13] = {
  ...
  { 290, 446, 5, 350, 240, 180, 210, 286, 330, 0 }, // 2 - L claw
  ...
  { 290, 446, 5, 350, 350, 290, 320, 456, 560, 0 }, // 6 - R claw increase to grab
